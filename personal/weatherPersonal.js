...
class WeatherPersonal {
    constructor() {
        this.WeatherPersonal = {};
    }
    CurrentWeather(body) {
        ...
        this.WeatherPersonal.mainTemp_min = +body.main.temp_min - 273;
        this.WeatherPersonal.mainTemp_max = +body.main.temp_max - 273;
    ...
    ForecastWeather(body) {
        ...
        for (let value of body) {
            ...
            this.WeatherPersonal.mainTemp_min = +value.main.temp_min - 273;
            this.WeatherPersonal.mainTemp_max = +value.main.temp_max - 273;
            this.WeatherPersonal.mainSea_level = value.main.sea_level;
            this.WeatherPersonal.mainGrnd_level = value.main.grnd_level;
            this.WeatherPersonal.mainTemp_kf = +value.main.temp_kf - 273;
...
exports.WeatherPersonal = WeatherPersonal;
//# sourceMappingURL=weatherPersonal.js.map